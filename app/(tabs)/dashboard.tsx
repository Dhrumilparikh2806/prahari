...
const styles = StyleSheet.create({
  ...
  syncedText: { fontSize: 11, fontFamily: FONTS.BODY_BOLD, color: TERRA.PRIMARY, letterSpacing: 0.5 },
  settingsBtn: { padding: 8 },
  settingsIcon: { fontSize: 20, color: TERRA.TEXT_SECONDARY },
  content: { flex: 1, paddingHorizontal: 20 },

  titleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 },
  repoLabel: { fontSize: 10, fontFamily: FONTS.BODY_BOLD, color: TERRA.PRIMARY, letterSpacing: 2, marginBottom: 4 },
  ...
  refreshLabel: { fontSize: 9, fontFamily: FONTS.BODY_BOLD, color: TERRA.TEXT_SECONDARY, letterSpacing: 1, textAlign: 'center' },

  statCard: { backgroundColor: TERRA.CARD, borderRadius: 12, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: TERRA.BORDER },
  statCardLabel: { fontSize: 10, fontFamily: FONTS.BODY_BOLD, color: TERRA.TEXT_MUTED, letterSpacing: 1.5, marginBottom: 4 },
  statCardValue: { fontSize: 36, fontFamily: FONTS.HEADLINE, color: TERRA.TEXT, lineHeight: 40 },
  statCardUnit: { fontSize: 11, fontFamily: FONTS.BODY, color: TERRA.TEXT_MUTED },

  tableHeader: { flexDirection: 'row', paddingVertical: 8, borderBottomWidth: 2, borderBottomColor: TERRA.PRIMARY, marginBottom: 4 },
  colHeader: { width: 48, fontSize: 10, fontFamily: FONTS.BODY_BOLD, color: TERRA.PRIMARY, letterSpacing: 0.5 },

  tableRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: TERRA.DIVIDER },
  rowName: { fontSize: 13, fontFamily: FONTS.BODY_MEDIUM, color: TERRA.TEXT },
  rowTime: { fontSize: 10, fontFamily: FONTS.BODY, color: TERRA.TEXT_MUTED },
  rowCell: { width: 48, fontSize: 12, fontFamily: FONTS.BODY_MEDIUM, color: TERRA.TEXT_SECONDARY },
  ...
  fetchingTitle: { fontSize: 14, fontFamily: FONTS.BODY_BOLD, color: TERRA.TEXT, letterSpacing: 1, marginBottom: 8 },
  fetchingBody: { fontSize: 12, fontFamily: FONTS.BODY, color: TERRA.TEXT_SECONDARY, textAlign: 'center', paddingHorizontal: 20 },

  footer: { flexDirection: 'row', justifyContent: 'space-between', paddingTop: 12 },
  footerText: { fontSize: 9, fontFamily: FONTS.BODY, color: TERRA.TEXT_MUTED, letterSpacing: 0.5 },
  ...
  liveText: { fontSize: 10, fontFamily: FONTS.BODY_BOLD, color: TERRA.PRIMARY, letterSpacing: 1 },
});
