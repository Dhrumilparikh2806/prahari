/**
 * _layout.tsx — Root Layout · Terra Theme
 * No external fonts needed — uses system serif (Georgia/Noto Serif)
 */
      ...
      {dbError ? (
        ...
        <MediaPipeProvider value={mediaPipe}>
          <GestureHandlerRootView style={styles.root}>
            ...
            />
            <Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: TERRA.BACKGROUND, flex: 1 } }}>
